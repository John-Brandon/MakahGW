...
$(PROJ_DIR)/main.app: $(OBJECT_FILES) $(PROJ_DIR)/proc.app $(PROJ_DIR)/aw-res7.app
...
# Compile executables that format output ------------------------------------------------
$(PROJ_DIR)/proc.app: $(CODE_DIR)/proc.o 
	gfortran $(GFFLAGS) $(CODE_DIR)/proc.o -o $(PROJ_DIR)/proc.app	

$(CODE_DIR)/proc.o: $(CODE_DIR)/Proc.FOR
	cd $(CODE_DIR);\
